...
/**
 * A robot abstraction. Give it a maze and an instruction set, and it will attempt to navigate to
 * the finish.
 * 
 * @author bkanber
 *
...
public class Robot
{
	 ...
	 * 
	 * @param sensorActions
	 *            The string to map the sensor value to actions
	 * @param maze
	 *            The maze the robot will use
	 * @param maxMoves
	 *            The maximum number of moves the robot can make
	 */
