...
/**
 * This class abstracts a maze through which a robot will have to navigate. The maze is represented
 * as a 2d array of integers, with different environment types represented by integers as follows:
 * 
 * 0 = Empty 1 = Wall 2 = Starting position 3 = Route 4 = Goal position
 * 
 * The most significant method in this class is `scoreRoute`, which will return a fitness score for
 * a path; it is this score that the genetic algorithm will optimize.
 * 
 * @author bkanber
 *
 */
public class Maze
{
	 ...
	 * Scores a maze route
	 * 
	 * This method inspects a route given as an array, and adds a point for each correct step made.
	 * We also have to be careful not to reward re-visiting correct paths, otherwise you could get
	 * an infinite score just by wiggling back and forth on the route.
	 * 
	 * @return int Max index
	 */
